...
class AppComponents(context: Context)
  ...
  val credsProvider = new AWSCredentialsProviderChain(DefaultAWSCredentialsProviderChain.getInstance(), new ProfileCredentialsProvider("security"))
  private val snsClient = AmazonSNSAsyncClientBuilder.standard()
  ...
  val iamJob = new IamJob(enabled = true, cacheService, snsClient, configuration)(executionContext)
