...
object EFS {
  ...
  def filterOutEfsUnknownUsages(secGrpToResources: Map[String, Set[SGInUse]]): Map[String, Set[SGInUse]] =
    secGrpToResources.view.mapValues(filterOutEfsUnknownUsagesFromSet).toMap
